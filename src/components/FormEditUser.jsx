...
const FormEditUser   = () => {
  ...
  useEffect(() => {
    const getusersById = async () => {
      try {
        ...
        console.log("Existing Gambar URL:", `${process.env.REACT_APP_API_URL}/uploads/users/${response.data.gambar}`);
        console.log("Existing CV PDF URL:", `${process.env.REACT_APP_API_URL}/uploads/users/${response.data.cv_pdf}`);
      } catch (error) {
  ...
  const updateusers = async (e) => {
    ...
    try {
      ...
      await axios.patch(`${process.env.REACT_APP_API_URL}/users/${id}`, formDataToSend, {
        headers: {
          ...
          <form onSubmit={updateusers}>
            <div className="mb-3">
              ...
              {existingGambar && !gambar && (
                <div className="mb-2">
                  <img 
                    src={`${process.env.REACT_APP_API_URL}/uploads/users/${existingGambar}`} 
                    alt="Gambar Saat Ini" 
            ...
            <div className="mb-3">
              ...
              {existingCvPdf && !cv_pdf && (
                <div className="mb-2">
                  <p>
                    CV Saat Ini: <a href={`${process.env.REACT_APP_API_URL}/uploads/users/${existingCvPdf}`} target="_blank" rel="noopener noreferrer">Lihat CV</a>
                  </p>
                </div>
              )}
              {cv_pdf && (
